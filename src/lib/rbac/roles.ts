...
export const customer_rep = ac.newRole({
    ticket: [
    "view.catalog",            // see ticket categories/classes
    "view.detail",             // view specific ticket type
    "update.booking",          // reschedule/change booking
...
export const senior_customer_rep = ac.newRole({
    ticket: [
    "view.catalog",            // see ticket categories/classes
    "view.detail",             // view specific ticket type
...
export const finance_admin = ac.newRole({
...
export const senior_finance_admin = ac.newRole({
  voucher: [
...
export const admin = ac.newRole({
  ...
  user: [
    ...
    "list-admin", "list-customer_rep", "list-senior_customer_rep", "list-finance_admin", "list-senior_finance_admin", "list-admin", "list-senior-admin"
  ],
...
export const senior_admin = ac.newRole({
    ticket: [
    "view.catalog",            // see ticket categories/classes
    "view.detail",             // view specific ticket type
    "create.booking",          // purchase/checkout
